...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n246: ZB = zb_or(n123, n243);
    let n247: ZB = zb_and(n212, n246);
    let n248: ZB = zb_and(n213, n246);
    let n249: ZB = zb_or(n247, n248);
    let n253: ZW = zw_bits_n(r_c20);
    let n254: ZW = zw_mix1(zw_splat(11400714819323198485u64), n253, 20u64);
    let n255: ZW = zw_mix2(zw_splat(11562461410679940143u64), n253, 20u64);
    let n256: ZW = zw_bits_n(n147);
    let n257: ZW = zw_mix1(n254, n256, 39u64);
    let n258: ZW = zw_mix2(n255, n256, 39u64);
    let n259: ZW = zw_bits_n(n210);
    let n260: ZW = zw_mix1(zw_splat(11400714819323198485u64), n259, 20u64);
    let n261: ZW = zw_mix2(zw_splat(11562461410679940143u64), n259, 20u64);
    let n262: ZW = zw_bits_n(n223);
    let n263: ZW = zw_mix1(n260, n262, 39u64);
    let n264: ZW = zw_mix2(n261, n262, 39u64);
    let n265: ZW = zw_bits_b(r_c41);
    let n266: ZW = zw_mix1(n263, n265, 41u64);
    let n267: ZW = zw_mix2(n264, n265, 41u64);
    let n268: ZW = zw_bits_n(n244);
    let n269: ZW = zw_mix1(n266, n268, 257u64);
    let n270: ZW = zw_mix2(n267, n268, 257u64);
    let n271: ZW = zw_bits_n(n245);
    let n272: ZW = zw_mix1(n269, n271, 270u64);
    let n273: ZW = zw_mix2(n270, n271, 270u64);
    ...
    let ok_v0_b1: u16 = ALL & zb_holds(r_c38) & zb_holds(n154) & zb_holds(n153) & zb_holds(n152) & zb_holds(n151) & zb_holds(n155) & zb_holds(n110) & zb_holds(n122) & zb_holds(r_c287) & zb_holds(n109) & zb_holds(n108) & zb_holds(n105) & zb_holds(n119) & zb_holds(n104) & zb_holds(n118) & zb_holds(r_c276) & zb_holds(n159) & zb_holds(n158) & zb_holds(n103) & zb_holds(n117) & zb_holds(r_c268) & zb_holds(n102) & zb_holds(n116) & zb_holds(n156) & zb_holds(n114) & zb_holds(n99) & zb_holds(n98) & zb_holds(r_c256) & zb_holds(n97) & zb_holds(n96) & zb_holds(n95) & zb_holds(n94) & zb_holds(n93) & zb_holds(r_c247) & zb_holds(n92) & zb_holds(n91) & zb_holds(n86) & zb_holds(n85) & zb_holds(r_c237) & zb_holds(n84) & zb_holds(n83) & zb_holds(n82) & zb_holds(n80) & zb_holds(n81) & zb_holds(n214) & zb_holds(n215);
    let bd_v0_b1: bool = !n107 || !n121 || !n106 || !n120 || !n101 || !n100 || !n157 || !n115 || !n90 || !n89 || !n88 || !n87;
    let live_v0_b1: u16 = ALL & zb_holds(n249);
    let sh0 = KShared0 {
        c39: n147,
        c20: r_c20,
    };
