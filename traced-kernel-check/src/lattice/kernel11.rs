...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n209: ZN = zsel_n(n128, n208, r_c20);
    let n210: ZN = zsel_n(n128, r_c253, n207);
    let n211: ZB = zn_gt(n209, zn_splat(P8::from_raw(0i32)));
    let n212: ZB = zn_le(n209, zn_splat(P8::from_raw(0i32)));
    let n213: ZB = zn_ge(n210, zn_splat(P8::from_raw(2981888i32)));
    let n214: ZB = zn_le(n210, zn_splat(P8::from_raw(3309568i32)));
    let n216: ZB = zn_le(r_c39, zn_splat(P8::from_raw(0i32)));
    let n217: ZB = zb_and(n129, n216);
    let n218: ZB = zn_gt(n169, zn_splat(P8::from_raw(0i32)));
    let n219: ZB = zb_and(n168, n218);
    let n220: ZN = zsel_n(n167, n169, r_c39);
    let n221: ZB = zb_or(n217, n219);
    let n222: ZN = zsel_n(n128, r_c39, n220);
    let n223: ZB = zn_gt(r_c276, zn_splat(P8::from_raw(0i32)));
    let n224: ZB = zn_le(r_c276, zn_splat(P8::from_raw(0i32)));
    let n225: ZN = zn_sub(r_c276, zn_splat(P8::from_raw(65536i32)));
    let n226: ZB = zn_le(n225, zn_splat(P8::from_raw(0i32)));
    let n227: ZB = zn_gt(n225, zn_splat(P8::from_raw(0i32)));
    let n228: ZN = zsel_n(n223, n225, r_c276);
    let n229: ZB = zn_eq(zn_splat(P8::from_raw(1179648i32)), r_c289);
    let n230: ZB = zb_not(n229);
    let n231: ZB = zb_and(n221, n229);
    let n232: ZB = zb_and(n221, n230);
    let n233: ZB = zb_and(n223, n232);
    let n234: ZB = zb_and(n224, n232);
    let n235: ZB = zb_and(n226, n233);
    let n236: ZB = zb_and(n227, n233);
    let n237: ZN = zsel_n(n226, zn_splat(P8::from_raw(1179648i32)), r_c289);
    let n238: ZB = zb_or(n235, n236);
    let n239: ZN = zsel_n(n223, n237, r_c289);
    let n240: ZB = zb_or(n234, n238);
    let n241: ZN = zsel_n(n229, r_c276, n228);
    let n242: ZN = zsel_n(n229, r_c289, n239);
    let n243: ZB = zb_or(n231, n240);
    let n244: ZN = zsel_n(n128, r_c276, n241);
    let n245: ZN = zsel_n(n128, r_c289, n242);
    let n246: ZB = zb_or(n128, n243);
    let n247: ZB = zb_and(n211, n246);
    let n248: ZB = zb_and(n212, n246);
    ...
    let n269: ZW = zw_mix1(n266, n268, 276u64);
    let n270: ZW = zw_mix2(n267, n268, 276u64);
    let n271: ZW = zw_bits_n(n245);
    let n272: ZW = zw_mix1(n269, n271, 289u64);
    let n273: ZW = zw_mix2(n270, n271, 289u64);
    ...
    let ok_v0_b1: u16 = ALL & zb_holds(r_c38) & zb_holds(n176) & zb_holds(n175) & zb_holds(n174) & zb_holds(n173) & zb_holds(n109) & zb_holds(n127) & zb_holds(r_c287) & zb_holds(n108) & zb_holds(n107) & zb_holds(n104) & zb_holds(n124) & zb_holds(n103) & zb_holds(n123) & zb_holds(r_c275) & zb_holds(n122) & zb_holds(n121) & zb_holds(n120) & zb_holds(n119) & zb_holds(n118) & zb_holds(r_c267) & zb_holds(n117) & zb_holds(n102) & zb_holds(n115) & zb_holds(n114) & zb_holds(n98) & zb_holds(n113) & zb_holds(r_c256) & zb_holds(n97) & zb_holds(n96) & zb_holds(n95) & zb_holds(n94) & zb_holds(n93) & zb_holds(r_c247) & zb_holds(n92) & zb_holds(n91) & zb_holds(n86) & zb_holds(n85) & zb_holds(r_c237) & zb_holds(n84) & zb_holds(n83) & zb_holds(n82) & zb_holds(n80) & zb_holds(n81) & zb_holds(n213) & zb_holds(n214);
