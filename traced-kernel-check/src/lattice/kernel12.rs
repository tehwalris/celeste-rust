...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n207: ZN = zn_mul(n206, zn_splat(P8::from_raw(163840i32)));
    let n208: ZN = zn_add(zn_splat(P8::from_raw(3145728i32)), n207);
    let n209: ZN = zn_sub(r_c20, zn_splat(P8::from_raw(65536i32)));
    let n210: ZN = zsel_n(n134, n209, r_c20);
    let n211: ZN = zsel_n(n134, r_c253, n208);
    ...
    let n218: ZB = zb_and(n135, n217);
    let n219: ZB = zn_gt(n194, zn_splat(P8::from_raw(0i32)));
    let n220: ZB = zb_and(n193, n219);
    let n221: ZN = zsel_n(n192, n194, r_c39);
    let n222: ZB = zb_or(n218, n220);
    let n223: ZN = zsel_n(n134, r_c39, n221);
    let n224: ZB = zb_or(n134, n222);
    let n225: ZB = zb_and(n212, n224);
    let n226: ZB = zb_and(n213, n224);
    let n227: ZB = zb_or(n225, n226);
    let n231: ZW = zw_bits_n(r_c20);
    let n232: ZW = zw_mix1(zw_splat(11400714819323198485u64), n231, 20u64);
    let n233: ZW = zw_mix2(zw_splat(11562461410679940143u64), n231, 20u64);
    let n234: ZW = zw_bits_n(n194);
    let n235: ZW = zw_mix1(n232, n234, 39u64);
    let n236: ZW = zw_mix2(n233, n234, 39u64);
    let n237: ZW = zw_bits_n(n210);
    let n238: ZW = zw_mix1(zw_splat(11400714819323198485u64), n237, 20u64);
    let n239: ZW = zw_mix2(zw_splat(11562461410679940143u64), n237, 20u64);
    let n240: ZW = zw_bits_n(n223);
    let n241: ZW = zw_mix1(n238, n240, 39u64);
    let n242: ZW = zw_mix2(n239, n240, 39u64);
    let n243: ZW = zw_bits_b(r_c41);
    let n244: ZW = zw_mix1(n241, n243, 41u64);
    let n245: ZW = zw_mix2(n242, n243, 41u64);
