...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n199: ZB = zn_eq(zn_splat(P8::from_raw(1179648i32)), r_c290);
    ...
    let n206: ZN = zn_mul(n205, zn_splat(P8::from_raw(163840i32)));
    ...
    let n210: ZN = zsel_n(n123, n209, r_c20);
    let n211: ZN = zsel_n(n123, r_c253, n207);
    let n212: ZB = zn_gt(n210, zn_splat(P8::from_raw(0i32)));
    let n213: ZB = zn_le(n210, zn_splat(P8::from_raw(0i32)));
    let n214: ZB = zn_ge(n211, zn_splat(P8::from_raw(2981888i32)));
    let n215: ZB = zn_le(n211, zn_splat(P8::from_raw(3309568i32)));
    let n217: ZB = zn_le(r_c39, zn_splat(P8::from_raw(0i32)));
    let n218: ZB = zb_and(n124, n217);
    let n219: ZB = zn_gt(n147, zn_splat(P8::from_raw(0i32)));
    let n220: ZB = zb_and(n146, n219);
    let n221: ZN = zsel_n(n145, n147, r_c39);
    let n222: ZB = zb_or(n218, n220);
    let n223: ZN = zsel_n(n123, r_c39, n221);
    let n224: ZB = zn_gt(r_c257, zn_splat(P8::from_raw(0i32)));
    let n225: ZB = zn_le(r_c257, zn_splat(P8::from_raw(0i32)));
    let n226: ZB = zn_le(n208, zn_splat(P8::from_raw(0i32)));
    let n227: ZB = zn_gt(n208, zn_splat(P8::from_raw(0i32)));
    let n228: ZN = zsel_n(n224, n208, r_c257);
    let n229: ZB = zn_eq(zn_splat(P8::from_raw(1179648i32)), r_c270);
    let n230: ZB = zb_not(n229);
    let n231: ZB = zb_and(n222, n229);
    let n232: ZB = zb_and(n222, n230);
    let n233: ZB = zb_and(n224, n232);
    let n234: ZB = zb_and(n225, n232);
    let n235: ZB = zb_and(n226, n233);
    let n236: ZB = zb_and(n227, n233);
    let n237: ZN = zsel_n(n226, zn_splat(P8::from_raw(1179648i32)), r_c270);
    let n238: ZB = zb_or(n235, n236);
    let n239: ZN = zsel_n(n224, n237, r_c270);
    let n240: ZB = zb_or(n234, n238);
    let n241: ZN = zsel_n(n229, r_c257, n228);
    let n242: ZN = zsel_n(n229, r_c270, n239);
    let n243: ZB = zb_or(n231, n240);
    let n244: ZN = zsel_n(n123, r_c257, n241);
    let n245: ZN = zsel_n(n123, r_c270, n242);
    let n246: ZB = zb_not(n199);
    let n247: ZB = zn_gt(r_c277, zn_splat(P8::from_raw(0i32)));
    let n248: ZB = zn_le(r_c277, zn_splat(P8::from_raw(0i32)));
    let n249: ZN = zn_sub(r_c277, zn_splat(P8::from_raw(65536i32)));
    let n250: ZB = zn_le(n249, zn_splat(P8::from_raw(0i32)));
    let n251: ZB = zn_gt(n249, zn_splat(P8::from_raw(0i32)));
    let n252: ZN = zsel_n(n250, zn_splat(P8::from_raw(1179648i32)), r_c290);
    let n253: ZN = zsel_n(n247, n249, r_c277);
    let n254: ZN = zsel_n(n247, n252, r_c290);
    let n255: ZN = zsel_n(n199, r_c277, n253);
    let n256: ZN = zsel_n(n199, r_c290, n254);
    let n257: ZN = zsel_n(n123, r_c277, n255);
    let n258: ZN = zsel_n(n123, r_c290, n256);
    let n259: ZB = zb_and(n199, n243);
    let n260: ZB = zb_and(n243, n246);
    let n261: ZB = zb_and(n247, n260);
    let n262: ZB = zb_and(n248, n260);
    let n263: ZB = zb_and(n250, n261);
    let n264: ZB = zb_and(n251, n261);
    let n265: ZB = zb_or(n263, n264);
    let n266: ZB = zb_or(n262, n265);
    let n267: ZB = zb_or(n259, n266);
    let n268: ZB = zb_or(n123, n267);
    let n269: ZB = zb_and(n212, n268);
    let n270: ZB = zb_and(n213, n268);
    let n271: ZB = zb_or(n269, n270);
    let n275: ZW = zw_bits_n(r_c20);
    let n276: ZW = zw_mix1(zw_splat(11400714819323198485u64), n275, 20u64);
    let n277: ZW = zw_mix2(zw_splat(11562461410679940143u64), n275, 20u64);
    let n278: ZW = zw_bits_n(n147);
    let n279: ZW = zw_mix1(n276, n278, 39u64);
    let n280: ZW = zw_mix2(n277, n278, 39u64);
    let n281: ZW = zw_bits_n(n210);
    let n282: ZW = zw_mix1(zw_splat(11400714819323198485u64), n281, 20u64);
    let n283: ZW = zw_mix2(zw_splat(11562461410679940143u64), n281, 20u64);
    let n284: ZW = zw_bits_n(n223);
    let n285: ZW = zw_mix1(n282, n284, 39u64);
    let n286: ZW = zw_mix2(n283, n284, 39u64);
    let n287: ZW = zw_bits_b(r_c41);
    let n288: ZW = zw_mix1(n285, n287, 41u64);
    let n289: ZW = zw_mix2(n286, n287, 41u64);
    let n290: ZW = zw_bits_n(n244);
    let n291: ZW = zw_mix1(n288, n290, 257u64);
    let n292: ZW = zw_mix2(n289, n290, 257u64);
    let n293: ZW = zw_bits_n(n245);
    let n294: ZW = zw_mix1(n291, n293, 270u64);
    let n295: ZW = zw_mix2(n292, n293, 270u64);
    let n296: ZW = zw_bits_n(n257);
    let n297: ZW = zw_mix1(n294, n296, 277u64);
    let n298: ZW = zw_mix2(n295, n296, 277u64);
    let n299: ZW = zw_bits_n(n258);
    let n300: ZW = zw_mix1(n297, n299, 290u64);
    let n301: ZW = zw_mix2(n298, n299, 290u64);
    ...
    let ok_v0_b1: u16 = ALL & zb_holds(r_c38) & zb_holds(n173) & zb_holds(n172) & zb_holds(n115) & zb_holds(n171) & zb_holds(n114) & zb_holds(n113) & zb_holds(r_c288) & zb_holds(n112) & zb_holds(n111) & zb_holds(n106) & zb_holds(n105) & zb_holds(n104) & zb_holds(n103) & zb_holds(r_c276) & zb_holds(n154) & zb_holds(n153) & zb_holds(n102) & zb_holds(n122) & zb_holds(r_c268) & zb_holds(n101) & zb_holds(n121) & zb_holds(n151) & zb_holds(n119) & zb_holds(n98) & zb_holds(n97) & zb_holds(r_c256) & zb_holds(n96) & zb_holds(n95) & zb_holds(n94) & zb_holds(n93) & zb_holds(n92) & zb_holds(r_c247) & zb_holds(n91) & zb_holds(n90) & zb_holds(n85) & zb_holds(n84) & zb_holds(r_c237) & zb_holds(n83) & zb_holds(n82) & zb_holds(n81) & zb_holds(n79) & zb_holds(n80) & zb_holds(n214) & zb_holds(n215);
    let bd_v0_b1: bool = !n110 || !n109 || !n108 || !n107 || !n100 || !n99 || !n152 || !n120 || !n89 || !n88 || !n87 || !n86;
    let live_v0_b1: u16 = ALL & zb_holds(n271);
    let sh0 = KShared0 {
        c39: n147,
        c20: r_c20,
    };
