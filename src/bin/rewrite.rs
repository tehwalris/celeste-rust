                    ...
                    *steps += 1;
                    ...
                    if f == 0 && byte == 0 && layer_of.get(&id) != Some(&1) {
                        ...
                        if let RemPrecision::Bits(b) = precision.rem {
                            mine.widen_to(celeste_rust::compiled::ids(), b, celeste_rust::frame::spd_width_log2(precision.spd), (precision.pos.x, precision.pos.y), precision.held.is_unknown(), precision.fruit.is_unknown(), precision.floors.is_unknown(), precision.platforms.is_unknown());
                        }
