...
use crate::cengine::interp::Interp;
use crate::cengine::refbridge::{
...
use crate::cengine::refdriver::{fresh_interp, run_frame_all, run_one};
...
impl RefEngine {
    ...
    pub fn new() -> Result<Self> {
        ...
        let st0 = crate::cengine::cart::fresh_state::<RefDomain>(&mut it.d);
        let mut st0 = run_one(&mut it, top, st0)?;
        crate::cengine::cart::inject_tile_flag_at(&mut st0);
    ...
    pub fn initial_state(&self) -> Result<OState> {
        crate::cengine::refbridge::to_interp_state(&self.base)
    }
    ...
    /// SPIKE INSTRUMENTATION: (expressions evaluated, statements executed) so far.
    pub fn op_counts(&self) -> (u64, u64) {
        (self.it.n_eval, self.it.n_stmt)
    }
