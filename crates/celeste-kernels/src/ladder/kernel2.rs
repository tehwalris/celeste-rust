...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n29: ZN = zn_add(zn_splat(P8::from_raw(65536i32)), r_c84);
    let n30: ZN = zn_rem(n29, zn_splat(P8::from_raw(1966080i32)));
    let n31: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), n30);
    let n33: ZN = zn_add(zn_splat(P8::from_raw(65536i32)), r_c86);
    let n34: ZB = zn_gt(r_c20, zn_splat(P8::from_raw(0i32)));
    let n35: ZB = zn_le(r_c20, zn_splat(P8::from_raw(0i32)));
    let n36: ZB = zn_gt(r_c39, zn_splat(P8::from_raw(0i32)));
    let n37: ZN = zn_sub(r_c39, zn_splat(P8::from_raw(65536i32)));
    let n38: ZB = zn_le(n37, zn_splat(P8::from_raw(0i32)));
    ...
    let n43: ZN = zsel_n(n42, n33, r_c86);
    let n44: ZN = zsel_n(n31, n43, r_c86);
    let n45: ZN = zsel_n(n31, n41, r_c85);
    let n46: ZB = zb_and(r_c38, n36);
    let n47: ZB = zb_and(n35, n46);
    let n52: ZN = zn_sub(r_c20, zn_splat(P8::from_raw(65536i32)));
    let n53: ZB = zn_gt(n37, zn_splat(P8::from_raw(0i32)));
    let n54: ZN = zsel_n(n34, n52, r_c20);
    let n55: ZB = zn_gt(n54, zn_splat(P8::from_raw(0i32)));
    let n56: ZB = zn_le(n54, zn_splat(P8::from_raw(0i32)));
    let n57: ZB = zb_not(n46);
    let n58: ZB = zb_and(n35, n57);
    let n59: ZB = zb_and(n47, n53);
    let n60: ZN = zsel_n(n46, n37, r_c39);
    let n61: ZB = zb_or(n58, n59);
    let n62: ZN = zsel_n(n34, r_c39, n60);
    let n63: ZB = zb_or(n34, n61);
    let n64: ZB = zb_and(n55, n63);
    let n65: ZB = zb_and(n56, n63);
    let n66: ZB = zb_or(n64, n65);
    let n69: ZW = zw_bits_n(r_c20);
    let n70: ZW = zw_mix1(zw_splat(11400714819323198485u64), n69, 20u64);
    let n71: ZW = zw_mix2(zw_splat(11562461410679940143u64), n69, 20u64);
    let n72: ZW = zw_bits_n(n37);
    let n73: ZW = zw_mix1(n70, n72, 39u64);
    let n74: ZW = zw_mix2(n71, n72, 39u64);
    let n75: ZW = zw_bits_b(r_c43);
    let n76: ZW = zw_mix1(n73, n75, 43u64);
    let n77: ZW = zw_mix2(n74, n75, 43u64);
    let n78: ZW = zw_bits_n(n30);
    let n79: ZW = zw_mix1(n76, n78, 84u64);
    let n80: ZW = zw_mix2(n77, n78, 84u64);
    let n81: ZW = zw_bits_n(n45);
    let n82: ZW = zw_mix1(n79, n81, 85u64);
    let n83: ZW = zw_mix2(n80, n81, 85u64);
    let n84: ZW = zw_bits_n(n44);
    let n85: ZW = zw_mix1(n82, n84, 86u64);
    let n86: ZW = zw_mix2(n83, n84, 86u64);
    let n87: ZW = zw_bits_n(r_c87);
    let n88: ZW = zw_mix1(n85, n87, 87u64);
    let n89: ZW = zw_mix2(n86, n87, 87u64);
    let n90: ZW = zw_bits_n(r_c88);
    let n91: ZW = zw_mix1(n88, n90, 88u64);
    let n92: ZW = zw_mix2(n89, n90, 88u64);
    let n93: ZW = zw_bits_n(n54);
    ...
    let n96: ZW = zw_bits_b(r_c38);
    let n97: ZW = zw_mix1(n94, n96, 38u64);
    let n98: ZW = zw_mix2(n95, n96, 38u64);
    let n99: ZW = zw_bits_n(n62);
    let n100: ZW = zw_mix1(n97, n99, 39u64);
    let n101: ZW = zw_mix2(n98, n99, 39u64);
    let n102: ZW = zw_bits_b(r_c41);
    let n103: ZW = zw_mix1(n100, n102, 41u64);
    let n104: ZW = zw_mix2(n101, n102, 41u64);
    let n105: ZW = zw_bits_b(r_c42);
    let n106: ZW = zw_mix1(n103, n105, 42u64);
    let n107: ZW = zw_mix2(n104, n105, 42u64);
    let n108: ZW = zw_mix1(n106, n75, 43u64);
    let n109: ZW = zw_mix2(n107, n75, 43u64);
    let n110: ZW = zw_mix1(n108, n78, 84u64);
    let n111: ZW = zw_mix2(n109, n78, 84u64);
    let n112: ZW = zw_mix1(n110, n81, 85u64);
    let n113: ZW = zw_mix2(n111, n81, 85u64);
    let n114: ZW = zw_mix1(n112, n84, 86u64);
    let n115: ZW = zw_mix2(n113, n84, 86u64);
    let n116: ZW = zw_mix1(n114, n87, 87u64);
    let n117: ZW = zw_mix2(n115, n87, 87u64);
    let n118: ZW = zw_mix1(n116, n90, 88u64);
    let n119: ZW = zw_mix2(n117, n90, 88u64);
    let ok_v0_b0: u16 = ALL;
    let bd_v0_b0: bool = false;
    let live_v0_b0: u16 = ALL & zb_holds(n35) & zb_holds(n38) & zb_holds(r_c38) & zb_holds(n36);
