...
pub const KPART1_0: u64 = 7210503927159084209;
pub const KPART2_0: u64 = 1073594781118294634;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 7711750164256218982;
pub const KPART2_1: u64 = 10271274008124805168;
...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n30: ZB = zb_not(r_c42);
    let n31: ZB = zn_eq(zn_splat(P8::from_raw(65536i32)), r_c88);
    let n33: ZN = zn_add(zn_splat(P8::from_raw(65536i32)), r_c84);
    let n34: ZN = zn_rem(n33, zn_splat(P8::from_raw(1966080i32)));
    let n35: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), n34);
    let n37: ZB = zb_not(r_c43);
    let n38: ZN = zn_add(zn_splat(P8::from_raw(65536i32)), r_c85);
    let n39: ZN = zn_rem(n38, zn_splat(P8::from_raw(3932160i32)));
    let n40: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), n39);
    let n41: ZN = zsel_n(n35, n39, r_c85);
    let n42: ZB = zn_gt(r_c20, zn_splat(P8::from_raw(0i32)));
    let n43: ZB = zn_le(r_c20, zn_splat(P8::from_raw(0i32)));
    let n47: ZN = zn_add(zn_splat(P8::from_raw(65536i32)), r_c86);
    let n48: ZN = zsel_n(n40, n47, r_c86);
    let n49: ZN = zsel_n(n35, n48, r_c86);
    let n50: ZB = zn_gt(r_c39, zn_splat(P8::from_raw(0i32)));
    let n51: ZB = zb_and(n43, n50);
    let n52: ZN = zn_sub(r_c39, zn_splat(P8::from_raw(65536i32)));
    let n53: ZB = zn_le(n52, zn_splat(P8::from_raw(0i32)));
    let n56: ZN = zn_sub(r_c20, zn_splat(P8::from_raw(65536i32)));
    let n57: ZN = zsel_n(n42, n56, r_c20);
    let n58: ZB = zn_le(r_c39, zn_splat(P8::from_raw(0i32)));
    let n59: ZB = zb_and(n43, n58);
    let n60: ZB = zn_gt(n52, zn_splat(P8::from_raw(0i32)));
    let n61: ZB = zb_and(n51, n60);
    let n62: ZN = zsel_n(n50, n52, r_c39);
    let n63: ZB = zb_or(n59, n61);
    let n64: ZN = zsel_n(n42, r_c39, n62);
    let n65: ZB = zb_or(n42, n63);
    let n67: ZW = zw_cellmix_n(20u64, r_c20, 1542469173u64);
    let n68: ZW = zw_cellmix_n(20u64, r_c20, 668265263u64);
    let n69: ZW = zw_add(zw_splat(0u64), n67);
    let n70: ZW = zw_add(zw_splat(0u64), n68);
    let n71: ZW = zw_cellmix_n(39u64, n52, 1542469173u64);
    let n72: ZW = zw_cellmix_n(39u64, n52, 668265263u64);
    let n73: ZW = zw_add(n69, n71);
    let n74: ZW = zw_add(n70, n72);
    let n75: ZW = zw_cellmix_n(84u64, n34, 1542469173u64);
    let n76: ZW = zw_cellmix_n(84u64, n34, 668265263u64);
    let n77: ZW = zw_add(n73, n75);
    let n78: ZW = zw_add(n74, n76);
    let n79: ZW = zw_cellmix_n(85u64, n41, 1542469173u64);
    let n80: ZW = zw_cellmix_n(85u64, n41, 668265263u64);
    let n81: ZW = zw_add(n77, n79);
    let n82: ZW = zw_add(n78, n80);
    let n83: ZW = zw_cellmix_n(86u64, n49, 1542469173u64);
    let n84: ZW = zw_cellmix_n(86u64, n49, 668265263u64);
    let n85: ZW = zw_add(n81, n83);
    let n86: ZW = zw_add(n82, n84);
    let n87: ZW = zw_cellmix_n(87u64, r_c87, 1542469173u64);
    let n88: ZW = zw_cellmix_n(87u64, r_c87, 668265263u64);
    let n89: ZW = zw_add(n85, n87);
    let n90: ZW = zw_add(n86, n88);
    let n91: ZW = zw_cellmix_n(20u64, n57, 1542469173u64);
    let n92: ZW = zw_cellmix_n(20u64, n57, 668265263u64);
    let n93: ZW = zw_add(zw_splat(0u64), n91);
    let n94: ZW = zw_add(zw_splat(0u64), n92);
    let n95: ZW = zw_cellmix_n(39u64, n64, 1542469173u64);
    let n96: ZW = zw_cellmix_n(39u64, n64, 668265263u64);
    let n97: ZW = zw_add(n93, n95);
    let n98: ZW = zw_add(n94, n96);
    let n99: ZW = zw_cellmix_b(41u64, r_c41, 1542469173u64);
    let n100: ZW = zw_cellmix_b(41u64, r_c41, 668265263u64);
    let n101: ZW = zw_add(n97, n99);
    let n102: ZW = zw_add(n98, n100);
    let n103: ZW = zw_add(n101, n75);
    let n104: ZW = zw_add(n102, n76);
    let n105: ZW = zw_add(n103, n79);
    let n106: ZW = zw_add(n104, n80);
    let n107: ZW = zw_add(n105, n83);
    let n108: ZW = zw_add(n106, n84);
    let n109: ZW = zw_add(n107, n87);
    let n110: ZW = zw_add(n108, n88);
    let ok_v0_b0: u16 = ALL & zb_holds(r_c38) & zb_holds(n37) & zb_holds(n30) & zb_holds(n31);
    let bd_v0_b0: bool = false;
    let live_v0_b0: u16 = ALL & zb_holds(n43) & zb_holds(n50) & zb_holds(n53);
    let ok_v0_b1: u16 = ALL & zb_holds(r_c38) & zb_holds(n37) & zb_holds(n30) & zb_holds(n31);
    let bd_v0_b1: bool = false;
    let live_v0_b1: u16 = ALL & zb_holds(n65);
    let sh0 = KShared0 {
        c87: r_c87,
        c39: n52,
        c84: n34,
