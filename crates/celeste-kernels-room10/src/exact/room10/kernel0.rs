...
pub const KPART1_0: u64 = 3318572250007493929;
pub const KPART2_0: u64 = 12723615399235786710;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 2866593999889891653;
pub const KPART2_1: u64 = 1160994242356539764;
