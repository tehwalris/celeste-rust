...
pub const KPART1_0: u64 = 12558673438643885994;
pub const KPART2_0: u64 = 9518534402604407792;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 13059919675741020767;
pub const KPART2_1: u64 = 269469555901366710;
