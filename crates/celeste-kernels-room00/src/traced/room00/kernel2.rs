...
pub const KPART1_0: u64 = 11955023389388518498;
pub const KPART2_0: u64 = 1129168542831296745;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 8787932473212165443;
pub const KPART2_1: u64 = 16179711109182809135;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_2: u64 = 10994114320322233806;
pub const KPART2_2: u64 = 2070489920862392601;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_3: u64 = 12799579268369568559;
pub const KPART2_3: u64 = 114838715740224039;
