...
pub const KPART1_0: u64 = 12017490009129618066;
pub const KPART2_0: u64 = 8557039558563185869;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 10114741950451373244;
pub const KPART2_1: u64 = 9415654177140911452;
...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n31: ZB = zb_not(r_c43);
    let n33: ZB = zn_gt(r_c20, zn_splat(P8::from_raw(0i32)));
    let n34: ZB = zn_le(r_c20, zn_splat(P8::from_raw(0i32)));
    ...
    let n64: ZW = zw_cellmix_n(20u64, r_c20, 1542469173u64);
    let n65: ZW = zw_cellmix_n(20u64, r_c20, 668265263u64);
    let n66: ZW = zw_add(zw_splat(0u64), n64);
    let n67: ZW = zw_add(zw_splat(0u64), n65);
    let n68: ZW = zw_cellmix_n(39u64, n38, 1542469173u64);
    let n69: ZW = zw_cellmix_n(39u64, n38, 668265263u64);
    let n70: ZW = zw_add(n66, n68);
    let n71: ZW = zw_add(n67, n69);
    let n72: ZW = zw_cellmix_n(20u64, n54, 1542469173u64);
    let n73: ZW = zw_cellmix_n(20u64, n54, 668265263u64);
    let n74: ZW = zw_add(zw_splat(0u64), n72);
    let n75: ZW = zw_add(zw_splat(0u64), n73);
    let n76: ZW = zw_cellmix_n(39u64, n61, 1542469173u64);
    let n77: ZW = zw_cellmix_n(39u64, n61, 668265263u64);
    let n78: ZW = zw_add(n74, n76);
    let n79: ZW = zw_add(n75, n77);
    let n80: ZW = zw_cellmix_b(41u64, r_c41, 1542469173u64);
    let n81: ZW = zw_cellmix_b(41u64, r_c41, 668265263u64);
