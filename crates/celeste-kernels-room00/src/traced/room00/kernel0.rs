...
pub const KPART1_0: u64 = 2885847111535349759;
pub const KPART2_0: u64 = 10652590569443917684;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 15334054535236237106;
pub const KPART2_1: u64 = 3338636186532427714;
