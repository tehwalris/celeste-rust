...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n460: ZW = zw_bits_n(r_c39);
    let n461: ZW = zw_mix1(zw_splat(11400714819323198485u64), n460, 39u64);
    let n462: ZW = zw_mix2(zw_splat(11562461410679940143u64), n460, 39u64);
    let n463: ZW = zw_bits_n(n232);
    let n464: ZW = zw_mix1(n461, n463, 300u64);
    let n465: ZW = zw_mix2(n462, n463, 300u64);
    let n466: ZW = zw_bits_n(r_c20);
    let n467: ZW = zw_mix1(n464, n466, 20u64);
    let n468: ZW = zw_mix2(n465, n466, 20u64);
    let n469: u64 = false as u64;
    let n470: ZW = zw_mix1(n467, zw_splat(n469), 41u64);
    let n471: ZW = zw_mix2(n468, zw_splat(n469), 41u64);
    let n472: u64 = P8::from_raw(0i32).as_raw_u32() as u64;
    let n473: ZW = zw_mix1(n470, zw_splat(n472), 280u64);
    let n474: ZW = zw_mix2(n471, zw_splat(n472), 280u64);
    let n475: ZW = zw_mix1(n473, zw_splat(n472), 282u64);
    let n476: ZW = zw_mix2(n474, zw_splat(n472), 282u64);
    let n477: u64 = P8::from_raw(65536i32).as_raw_u32() as u64;
    let n478: ZW = zw_mix1(n475, zw_splat(n477), 283u64);
    let n479: ZW = zw_mix2(n476, zw_splat(n477), 283u64);
    let n480: ZW = zw_bits_n(n345);
    let n481: ZW = zw_mix1(n478, n480, 285u64);
    let n482: ZW = zw_mix2(n479, n480, 285u64);
    let n483: ZW = zw_mix1(n481, zw_splat(n469), 292u64);
    let n484: ZW = zw_mix2(n482, zw_splat(n469), 292u64);
    let n485: ZW = zw_mix1(n483, zw_splat(n469), 293u64);
    let n486: ZW = zw_mix2(n484, zw_splat(n469), 293u64);
    let n487: ZW = zw_mix1(n485, zw_splat(n472), 356u64);
    let n488: ZW = zw_mix2(n486, zw_splat(n472), 356u64);
    let n489: ZW = zw_mix1(n487, zw_splat(n472), 357u64);
    let n490: ZW = zw_mix2(n488, zw_splat(n472), 357u64);
    let n491: ZW = zw_mix1(n489, zw_splat(n472), 358u64);
    let n492: ZW = zw_mix2(n490, zw_splat(n472), 358u64);
    let n493: ZW = zw_mix1(n491, zw_splat(n472), 359u64);
    let n494: ZW = zw_mix2(n492, zw_splat(n472), 359u64);
    let n495: ZW = zw_mix1(n493, zw_splat(n469), 360u64);
    let n496: ZW = zw_mix2(n494, zw_splat(n469), 360u64);
    let n497: ZW = zw_mix1(n495, zw_splat(n472), 368u64);
    let n498: ZW = zw_mix2(n496, zw_splat(n472), 368u64);
    let n499: ZW = zw_bits_n(n350);
    let n500: ZW = zw_mix1(n497, n499, 369u64);
    let n501: ZW = zw_mix2(n498, n499, 369u64);
    let n502: u64 = true as u64;
    let n503: ZW = zw_mix1(n493, zw_splat(n502), 360u64);
    let n504: ZW = zw_mix2(n494, zw_splat(n502), 360u64);
    let n505: ZW = zw_bits_n(n372);
    let n506: ZW = zw_mix1(n503, n505, 368u64);
    let n507: ZW = zw_mix2(n504, n505, 368u64);
    let n508: ZW = zw_mix1(n506, n499, 369u64);
    let n509: ZW = zw_mix2(n507, n499, 369u64);
    let n510: ZW = zw_bits_n(n375);
    let n511: ZW = zw_mix1(n495, n510, 368u64);
    let n512: ZW = zw_mix2(n496, n510, 368u64);
    let n513: ZW = zw_mix1(n511, n499, 369u64);
    let n514: ZW = zw_mix2(n512, n499, 369u64);
    let n515: ZW = zw_bits_n(n362);
    let n516: ZW = zw_mix1(n478, n515, 285u64);
    let n517: ZW = zw_mix2(n479, n515, 285u64);
    let n518: ZW = zw_mix1(n516, zw_splat(n469), 292u64);
    let n519: ZW = zw_mix2(n517, zw_splat(n469), 292u64);
    let n520: ZW = zw_mix1(n518, zw_splat(n502), 293u64);
    let n521: ZW = zw_mix2(n519, zw_splat(n502), 293u64);
    let n522: ZW = zw_mix1(n520, zw_splat(n472), 356u64);
    let n523: ZW = zw_mix2(n521, zw_splat(n472), 356u64);
    let n524: ZW = zw_mix1(n522, zw_splat(n472), 357u64);
    let n525: ZW = zw_mix2(n523, zw_splat(n472), 357u64);
    let n526: ZW = zw_mix1(n524, zw_splat(n472), 358u64);
    let n527: ZW = zw_mix2(n525, zw_splat(n472), 358u64);
    let n528: ZW = zw_mix1(n526, zw_splat(n472), 359u64);
    let n529: ZW = zw_mix2(n527, zw_splat(n472), 359u64);
    let n530: ZW = zw_mix1(n528, zw_splat(n469), 360u64);
    let n531: ZW = zw_mix2(n529, zw_splat(n469), 360u64);
    let n532: ZW = zw_bits_n(n363);
    let n533: ZW = zw_mix1(n530, n532, 368u64);
    let n534: ZW = zw_mix2(n531, n532, 368u64);
    let n535: ZW = zw_bits_n(n364);
    let n536: ZW = zw_mix1(n533, n535, 369u64);
    let n537: ZW = zw_mix2(n534, n535, 369u64);
    let n538: ZW = zw_mix1(n528, zw_splat(n502), 360u64);
    let n539: ZW = zw_mix2(n529, zw_splat(n502), 360u64);
    let n540: ZW = zw_bits_n(n374);
    let n541: ZW = zw_mix1(n538, n540, 368u64);
    let n542: ZW = zw_mix2(n539, n540, 368u64);
    let n543: ZW = zw_mix1(n541, n535, 369u64);
    let n544: ZW = zw_mix2(n542, n535, 369u64);
    let n545: ZW = zw_bits_n(n377);
    let n546: ZW = zw_mix1(n530, n545, 368u64);
    let n547: ZW = zw_mix2(n531, n545, 368u64);
    let n548: ZW = zw_mix1(n546, n535, 369u64);
    let n549: ZW = zw_mix2(n547, n535, 369u64);
    let n550: u64 = P8::from_raw(131072i32).as_raw_u32() as u64;
    let n551: ZW = zw_mix1(n464, zw_splat(n550), 20u64);
    let n552: ZW = zw_mix2(n465, zw_splat(n550), 20u64);
    let n553: ZW = zw_mix1(n551, zw_splat(n502), 41u64);
    let n554: ZW = zw_mix2(n552, zw_splat(n502), 41u64);
    let n555: u64 = P8::from_raw(655360i32).as_raw_u32() as u64;
    let n556: ZW = zw_mix1(n553, zw_splat(n555), 280u64);
    let n557: ZW = zw_mix2(n554, zw_splat(n555), 280u64);
    let n558: u64 = P8::from_raw(262144i32).as_raw_u32() as u64;
    let n559: ZW = zw_mix1(n556, zw_splat(n558), 282u64);
    let n560: ZW = zw_mix2(n557, zw_splat(n558), 282u64);
    let n561: ZW = zw_mix1(n559, zw_splat(n472), 283u64);
    let n562: ZW = zw_mix2(n560, zw_splat(n472), 283u64);
    let n563: ZW = zw_mix1(n561, n480, 285u64);
    let n564: ZW = zw_mix2(n562, n480, 285u64);
    let n565: ZW = zw_mix1(n563, zw_splat(n502), 292u64);
    let n566: ZW = zw_mix2(n564, zw_splat(n502), 292u64);
    let n567: ZW = zw_mix1(n565, zw_splat(n469), 293u64);
    let n568: ZW = zw_mix2(n566, zw_splat(n469), 293u64);
    let n569: u64 = P8::from_raw(98304i32).as_raw_u32() as u64;
    let n570: ZW = zw_mix1(n567, zw_splat(n569), 356u64);
    let n571: ZW = zw_mix2(n568, zw_splat(n569), 356u64);
    let n572: u64 = P8::from_raw(69510i32).as_raw_u32() as u64;
    let n573: ZW = zw_mix1(n570, zw_splat(n572), 357u64);
    let n574: ZW = zw_mix2(n571, zw_splat(n572), 357u64);
    let n575: ZW = zw_mix1(n573, zw_splat(n550), 358u64);
    let n576: ZW = zw_mix2(n574, zw_splat(n550), 358u64);
    let n577: ZW = zw_mix1(n575, zw_splat(n472), 359u64);
    let n578: ZW = zw_mix2(n576, zw_splat(n472), 359u64);
    let n579: ZW = zw_mix1(n577, zw_splat(n469), 360u64);
    let n580: ZW = zw_mix2(n578, zw_splat(n469), 360u64);
    let n581: ZW = zw_mix1(n579, zw_splat(n477), 368u64);
    let n582: ZW = zw_mix2(n580, zw_splat(n477), 368u64);
    let n583: ZW = zw_mix1(n581, zw_splat(n472), 369u64);
    let n584: ZW = zw_mix2(n582, zw_splat(n472), 369u64);
    let n585: u64 = P8::from_raw(-131072i32).as_raw_u32() as u64;
    let n586: ZW = zw_mix1(n573, zw_splat(n585), 358u64);
    let n587: ZW = zw_mix2(n574, zw_splat(n585), 358u64);
    let n588: ZW = zw_mix1(n586, zw_splat(n472), 359u64);
    let n589: ZW = zw_mix2(n587, zw_splat(n472), 359u64);
    let n590: ZW = zw_mix1(n588, zw_splat(n502), 360u64);
    let n591: ZW = zw_mix2(n589, zw_splat(n502), 360u64);
    let n592: u64 = P8::from_raw(-327680i32).as_raw_u32() as u64;
    let n593: ZW = zw_mix1(n590, zw_splat(n592), 368u64);
    let n594: ZW = zw_mix2(n591, zw_splat(n592), 368u64);
    let n595: ZW = zw_mix1(n593, zw_splat(n472), 369u64);
    let n596: ZW = zw_mix2(n594, zw_splat(n472), 369u64);
    let n597: u64 = P8::from_raw(327680i32).as_raw_u32() as u64;
    let n598: ZW = zw_mix1(n579, zw_splat(n597), 368u64);
    let n599: ZW = zw_mix2(n580, zw_splat(n597), 368u64);
    let n600: ZW = zw_mix1(n598, zw_splat(n472), 369u64);
    let n601: ZW = zw_mix2(n599, zw_splat(n472), 369u64);
    let n602: ZW = zw_mix1(n567, zw_splat(n572), 356u64);
    let n603: ZW = zw_mix2(n568, zw_splat(n572), 356u64);
    let n604: ZW = zw_mix1(n602, zw_splat(n569), 357u64);
    let n605: ZW = zw_mix2(n603, zw_splat(n569), 357u64);
    let n606: ZW = zw_mix1(n604, zw_splat(n472), 358u64);
    let n607: ZW = zw_mix2(n605, zw_splat(n472), 358u64);
    let n608: u64 = P8::from_raw(-98304i32).as_raw_u32() as u64;
    let n609: ZW = zw_mix1(n606, zw_splat(n608), 359u64);
    let n610: ZW = zw_mix2(n607, zw_splat(n608), 359u64);
    let n611: ZW = zw_mix1(n609, zw_splat(n469), 360u64);
    let n612: ZW = zw_mix2(n610, zw_splat(n469), 360u64);
    let n613: ZW = zw_mix1(n611, zw_splat(n472), 368u64);
    let n614: ZW = zw_mix2(n612, zw_splat(n472), 368u64);
    let n615: ZW = zw_mix1(n613, zw_splat(n592), 369u64);
    let n616: ZW = zw_mix2(n614, zw_splat(n592), 369u64);
    let n617: ZW = zw_mix1(n602, zw_splat(n572), 357u64);
    let n618: ZW = zw_mix2(n603, zw_splat(n572), 357u64);
    let n619: ZW = zw_mix1(n617, zw_splat(n585), 358u64);
    let n620: ZW = zw_mix2(n618, zw_splat(n585), 358u64);
    let n621: ZW = zw_mix1(n619, zw_splat(n608), 359u64);
    let n622: ZW = zw_mix2(n620, zw_splat(n608), 359u64);
    let n623: ZW = zw_mix1(n621, zw_splat(n502), 360u64);
    let n624: ZW = zw_mix2(n622, zw_splat(n502), 360u64);
    let n625: u64 = P8::from_raw(-231700i32).as_raw_u32() as u64;
    let n626: ZW = zw_mix1(n623, zw_splat(n625), 368u64);
    let n627: ZW = zw_mix2(n624, zw_splat(n625), 368u64);
    let n628: ZW = zw_mix1(n626, zw_splat(n625), 369u64);
    let n629: ZW = zw_mix2(n627, zw_splat(n625), 369u64);
    let n630: ZW = zw_mix1(n617, zw_splat(n550), 358u64);
    let n631: ZW = zw_mix2(n618, zw_splat(n550), 358u64);
    let n632: ZW = zw_mix1(n630, zw_splat(n608), 359u64);
    let n633: ZW = zw_mix2(n631, zw_splat(n608), 359u64);
    let n634: ZW = zw_mix1(n632, zw_splat(n469), 360u64);
    let n635: ZW = zw_mix2(n633, zw_splat(n469), 360u64);
    let n636: u64 = P8::from_raw(231700i32).as_raw_u32() as u64;
    let n637: ZW = zw_mix1(n634, zw_splat(n636), 368u64);
    let n638: ZW = zw_mix2(n635, zw_splat(n636), 368u64);
    let n639: ZW = zw_mix1(n637, zw_splat(n625), 369u64);
    let n640: ZW = zw_mix2(n638, zw_splat(n625), 369u64);
    let n641: ZW = zw_mix1(n606, zw_splat(n550), 359u64);
    let n642: ZW = zw_mix2(n607, zw_splat(n550), 359u64);
    let n643: ZW = zw_mix1(n641, zw_splat(n469), 360u64);
    let n644: ZW = zw_mix2(n642, zw_splat(n469), 360u64);
    let n645: ZW = zw_mix1(n643, zw_splat(n472), 368u64);
    let n646: ZW = zw_mix2(n644, zw_splat(n472), 368u64);
    let n647: ZW = zw_mix1(n645, zw_splat(n597), 369u64);
    let n648: ZW = zw_mix2(n646, zw_splat(n597), 369u64);
    let n649: ZW = zw_mix1(n619, zw_splat(n550), 359u64);
    let n650: ZW = zw_mix2(n620, zw_splat(n550), 359u64);
    let n651: ZW = zw_mix1(n649, zw_splat(n502), 360u64);
    let n652: ZW = zw_mix2(n650, zw_splat(n502), 360u64);
    let n653: ZW = zw_mix1(n651, zw_splat(n625), 368u64);
    let n654: ZW = zw_mix2(n652, zw_splat(n625), 368u64);
    let n655: ZW = zw_mix1(n653, zw_splat(n636), 369u64);
    let n656: ZW = zw_mix2(n654, zw_splat(n636), 369u64);
    let n657: ZW = zw_mix1(n630, zw_splat(n550), 359u64);
    let n658: ZW = zw_mix2(n631, zw_splat(n550), 359u64);
    let n659: ZW = zw_mix1(n657, zw_splat(n469), 360u64);
    let n660: ZW = zw_mix2(n658, zw_splat(n469), 360u64);
    let n661: ZW = zw_mix1(n659, zw_splat(n636), 368u64);
    let n662: ZW = zw_mix2(n660, zw_splat(n636), 368u64);
    let n663: ZW = zw_mix1(n661, zw_splat(n636), 369u64);
    let n664: ZW = zw_mix2(n662, zw_splat(n636), 369u64);
    let n665: ZW = zw_mix1(n561, n515, 285u64);
    let n666: ZW = zw_mix2(n562, n515, 285u64);
    let n667: ZW = zw_mix1(n665, zw_splat(n502), 292u64);
    let n668: ZW = zw_mix2(n666, zw_splat(n502), 292u64);
    let n669: ZW = zw_mix1(n667, zw_splat(n502), 293u64);
    let n670: ZW = zw_mix2(n668, zw_splat(n502), 293u64);
    let n671: ZW = zw_mix1(n669, zw_splat(n569), 356u64);
    let n672: ZW = zw_mix2(n670, zw_splat(n569), 356u64);
    let n673: ZW = zw_mix1(n671, zw_splat(n572), 357u64);
    let n674: ZW = zw_mix2(n672, zw_splat(n572), 357u64);
    let n675: ZW = zw_mix1(n673, zw_splat(n550), 358u64);
    let n676: ZW = zw_mix2(n674, zw_splat(n550), 358u64);
    let n677: ZW = zw_mix1(n675, zw_splat(n472), 359u64);
    let n678: ZW = zw_mix2(n676, zw_splat(n472), 359u64);
    let n679: ZW = zw_mix1(n677, zw_splat(n469), 360u64);
    let n680: ZW = zw_mix2(n678, zw_splat(n469), 360u64);
    let n681: ZW = zw_mix1(n679, zw_splat(n477), 368u64);
    let n682: ZW = zw_mix2(n680, zw_splat(n477), 368u64);
    let n683: ZW = zw_mix1(n681, zw_splat(n472), 369u64);
    let n684: ZW = zw_mix2(n682, zw_splat(n472), 369u64);
    let n685: ZW = zw_mix1(n673, zw_splat(n585), 358u64);
    let n686: ZW = zw_mix2(n674, zw_splat(n585), 358u64);
    let n687: ZW = zw_mix1(n685, zw_splat(n472), 359u64);
    let n688: ZW = zw_mix2(n686, zw_splat(n472), 359u64);
    let n689: ZW = zw_mix1(n687, zw_splat(n502), 360u64);
    let n690: ZW = zw_mix2(n688, zw_splat(n502), 360u64);
    let n691: ZW = zw_mix1(n689, zw_splat(n592), 368u64);
    let n692: ZW = zw_mix2(n690, zw_splat(n592), 368u64);
    let n693: ZW = zw_mix1(n691, zw_splat(n472), 369u64);
    let n694: ZW = zw_mix2(n692, zw_splat(n472), 369u64);
    let n695: ZW = zw_mix1(n679, zw_splat(n597), 368u64);
    let n696: ZW = zw_mix2(n680, zw_splat(n597), 368u64);
    let n697: ZW = zw_mix1(n695, zw_splat(n472), 369u64);
    let n698: ZW = zw_mix2(n696, zw_splat(n472), 369u64);
    let n699: ZW = zw_mix1(n669, zw_splat(n572), 356u64);
    let n700: ZW = zw_mix2(n670, zw_splat(n572), 356u64);
    let n701: ZW = zw_mix1(n699, zw_splat(n569), 357u64);
    let n702: ZW = zw_mix2(n700, zw_splat(n569), 357u64);
    let n703: ZW = zw_mix1(n701, zw_splat(n472), 358u64);
    let n704: ZW = zw_mix2(n702, zw_splat(n472), 358u64);
    let n705: ZW = zw_mix1(n703, zw_splat(n608), 359u64);
    let n706: ZW = zw_mix2(n704, zw_splat(n608), 359u64);
    let n707: ZW = zw_mix1(n705, zw_splat(n469), 360u64);
    let n708: ZW = zw_mix2(n706, zw_splat(n469), 360u64);
    let n709: ZW = zw_mix1(n707, zw_splat(n472), 368u64);
    let n710: ZW = zw_mix2(n708, zw_splat(n472), 368u64);
    let n711: ZW = zw_mix1(n709, zw_splat(n592), 369u64);
    let n712: ZW = zw_mix2(n710, zw_splat(n592), 369u64);
    let n713: ZW = zw_mix1(n699, zw_splat(n572), 357u64);
    let n714: ZW = zw_mix2(n700, zw_splat(n572), 357u64);
    let n715: ZW = zw_mix1(n713, zw_splat(n585), 358u64);
    let n716: ZW = zw_mix2(n714, zw_splat(n585), 358u64);
    let n717: ZW = zw_mix1(n715, zw_splat(n608), 359u64);
    let n718: ZW = zw_mix2(n716, zw_splat(n608), 359u64);
    let n719: ZW = zw_mix1(n717, zw_splat(n502), 360u64);
    let n720: ZW = zw_mix2(n718, zw_splat(n502), 360u64);
    let n721: ZW = zw_mix1(n719, zw_splat(n625), 368u64);
    let n722: ZW = zw_mix2(n720, zw_splat(n625), 368u64);
    let n723: ZW = zw_mix1(n721, zw_splat(n625), 369u64);
    let n724: ZW = zw_mix2(n722, zw_splat(n625), 369u64);
    let n725: ZW = zw_mix1(n713, zw_splat(n550), 358u64);
    let n726: ZW = zw_mix2(n714, zw_splat(n550), 358u64);
    let n727: ZW = zw_mix1(n725, zw_splat(n608), 359u64);
    let n728: ZW = zw_mix2(n726, zw_splat(n608), 359u64);
    let n729: ZW = zw_mix1(n727, zw_splat(n469), 360u64);
    let n730: ZW = zw_mix2(n728, zw_splat(n469), 360u64);
    let n731: ZW = zw_mix1(n729, zw_splat(n636), 368u64);
    let n732: ZW = zw_mix2(n730, zw_splat(n636), 368u64);
    let n733: ZW = zw_mix1(n731, zw_splat(n625), 369u64);
    let n734: ZW = zw_mix2(n732, zw_splat(n625), 369u64);
    let n735: ZW = zw_mix1(n703, zw_splat(n550), 359u64);
    let n736: ZW = zw_mix2(n704, zw_splat(n550), 359u64);
    let n737: ZW = zw_mix1(n735, zw_splat(n469), 360u64);
    let n738: ZW = zw_mix2(n736, zw_splat(n469), 360u64);
    let n739: ZW = zw_mix1(n737, zw_splat(n472), 368u64);
    let n740: ZW = zw_mix2(n738, zw_splat(n472), 368u64);
    let n741: ZW = zw_mix1(n739, zw_splat(n597), 369u64);
    let n742: ZW = zw_mix2(n740, zw_splat(n597), 369u64);
    let n743: ZW = zw_mix1(n715, zw_splat(n550), 359u64);
    let n744: ZW = zw_mix2(n716, zw_splat(n550), 359u64);
    let n745: ZW = zw_mix1(n743, zw_splat(n502), 360u64);
    let n746: ZW = zw_mix2(n744, zw_splat(n502), 360u64);
    let n747: ZW = zw_mix1(n745, zw_splat(n625), 368u64);
    let n748: ZW = zw_mix2(n746, zw_splat(n625), 368u64);
    let n749: ZW = zw_mix1(n747, zw_splat(n636), 369u64);
    let n750: ZW = zw_mix2(n748, zw_splat(n636), 369u64);
    let n751: ZW = zw_mix1(n725, zw_splat(n550), 359u64);
    let n752: ZW = zw_mix2(n726, zw_splat(n550), 359u64);
    let n753: ZW = zw_mix1(n751, zw_splat(n469), 360u64);
    let n754: ZW = zw_mix2(n752, zw_splat(n469), 360u64);
    let n755: ZW = zw_mix1(n753, zw_splat(n636), 368u64);
    let n756: ZW = zw_mix2(n754, zw_splat(n636), 368u64);
    let n757: ZW = zw_mix1(n755, zw_splat(n636), 369u64);
    let n758: ZW = zw_mix2(n756, zw_splat(n636), 369u64);
    let n759: ZW = zw_mix1(zw_splat(11400714819323198485u64), n466, 20u64);
    let n760: ZW = zw_mix2(zw_splat(11562461410679940143u64), n466, 20u64);
    let n761: ZW = zw_mix1(n759, zw_splat(n469), 41u64);
    let n762: ZW = zw_mix2(n760, zw_splat(n469), 41u64);
    let n763: u64 = mix64(11400714819323198485u64 ^ mix64(n550 ^ 20u64));
    let n764: u64 = 11562461410679940143u64.wrapping_add(mix64(n550.wrapping_mul((20u64 << 1) | 1)));
    let n765: u64 = mix64(n763 ^ mix64(n502 ^ 41u64));
    let n766: u64 = n764.wrapping_add(mix64(n502.wrapping_mul((41u64 << 1) | 1)));
    let n767: ZW = zw_bits_b(n404);
    let n768: ZW = zw_mix1(zw_splat(11400714819323198485u64), n767, 38u64);
    let n769: ZW = zw_mix2(zw_splat(11562461410679940143u64), n767, 38u64);
    let n770: ZW = zw_bits_n(n403);
    let n771: ZW = zw_mix1(n768, n770, 39u64);
    let n772: ZW = zw_mix2(n769, n770, 39u64);
    let n773: ZW = zw_mix1(n771, n466, 20u64);
    let n774: ZW = zw_mix2(n772, n466, 20u64);
    let n775: ZW = zw_mix1(n771, zw_splat(n550), 20u64);
    let n776: ZW = zw_mix2(n772, zw_splat(n550), 20u64);
    let n777: ZW = zw_bits_n(n410);
    let n778: ZW = zw_mix1(zw_splat(11400714819323198485u64), n777, 20u64);
    let n779: ZW = zw_mix2(zw_splat(11562461410679940143u64), n777, 20u64);
    let n780: ZW = zw_mix1(n778, n460, 39u64);
    let n781: ZW = zw_mix2(n779, n460, 39u64);
    let n782: ZW = zw_bits_n(n452);
    let n783: ZW = zw_mix1(n780, n782, 241u64);
    let n784: ZW = zw_mix2(n781, n782, 241u64);
    let n785: ZW = zw_bits_n(n429);
    let n786: ZW = zw_mix1(n783, n785, 252u64);
    let n787: ZW = zw_mix2(n784, n785, 252u64);
    let n788: ZW = zw_bits_n(n453);
    let n789: ZW = zw_mix1(n786, n788, 253u64);
    let n790: ZW = zw_mix2(n787, n788, 253u64);
    let n791: ZW = zw_bits_n(n454);
    let n792: ZW = zw_mix1(n789, n791, 257u64);
    let n793: ZW = zw_mix2(n790, n791, 257u64);
    let n794: ZW = zw_bits_n(n455);
    let n795: ZW = zw_mix1(n792, n794, 337u64);
    let n796: ZW = zw_mix2(n793, n794, 337u64);
    let n797: ZW = zw_bits_n(n456);
    let n798: ZW = zw_mix1(n795, n797, 339u64);
    let n799: ZW = zw_mix2(n796, n797, 339u64);
    ...
    let o1 = KOut1 {
        c20: zn_splat(P8::from_raw(131072i32)),
        c41: zb_splat(true),
        h1: zw_splat(n765), h2: zw_splat(n766),
    };
