...
pub const KPART1_0: u64 = 16039999660254965850;
pub const KPART2_0: u64 = 12171360412975289030;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 8734926981232267024;
pub const KPART2_1: u64 = 5597391774992309109;
...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n201: ZB = zn_eq(zn_splat(P8::from_raw(1179648i32)), r_c290);
    let n202: ZI = zi_add(zi_splat(P8::from_raw(65536i32), P8::from_raw(65536i32)), r_c245);
    let n205: (P8, P8) = { let r = IV::new((P8::from_raw(-65536i32), P8::from_raw(65536i32)).0, (P8::from_raw(-65536i32), P8::from_raw(65536i32)).1).scale_positive(P8::from_raw(163840i32)); (r.low, r.high) };
    let n206: (P8, P8) = si_add((P8::from_raw(3145728i32), P8::from_raw(3145728i32)), n205);
    let n207: ZN = zn_sub(r_c257, zn_splat(P8::from_raw(65536i32)));
    let n208: ZN = zn_sub(r_c20, zn_splat(P8::from_raw(65536i32)));
    let n209: ZN = zsel_n(n124, n208, r_c20);
    let n210: ZI = zsel_i(n124, r_c245, n202);
    let n211: ZI = zsel_i(n124, r_c253, zi_splat(n206.0, n206.1));
    let n212: ZB = zn_le(r_c39, zn_splat(P8::from_raw(0i32)));
    let n213: ZB = zn_gt(n144, zn_splat(P8::from_raw(0i32)));
    let n214: ZN = zsel_n(n143, n144, r_c39);
    let n215: ZN = zsel_n(n124, r_c39, n214);
    let n216: ZB = zn_gt(r_c257, zn_splat(P8::from_raw(0i32)));
    let n217: ZB = zn_le(n207, zn_splat(P8::from_raw(0i32)));
    let n218: ZN = zsel_n(n216, n207, r_c257);
    let n219: ZB = zn_eq(zn_splat(P8::from_raw(1179648i32)), r_c270);
    let n220: ZN = zsel_n(n217, zn_splat(P8::from_raw(1179648i32)), r_c270);
    let n221: ZN = zsel_n(n216, n220, r_c270);
    let n222: ZN = zsel_n(n219, r_c257, n218);
    let n223: ZN = zsel_n(n219, r_c270, n221);
    let n224: ZN = zsel_n(n124, r_c257, n222);
    let n225: ZN = zsel_n(n124, r_c270, n223);
    let n226: ZB = zn_gt(r_c277, zn_splat(P8::from_raw(0i32)));
    let n227: ZN = zn_sub(r_c277, zn_splat(P8::from_raw(65536i32)));
    let n228: ZB = zn_le(n227, zn_splat(P8::from_raw(0i32)));
    let n229: ZN = zsel_n(n228, zn_splat(P8::from_raw(1179648i32)), r_c290);
    let n230: ZN = zsel_n(n226, n227, r_c277);
    let n231: ZN = zsel_n(n226, n229, r_c290);
    let n232: ZN = zsel_n(n201, r_c277, n230);
    let n233: ZN = zsel_n(n201, r_c290, n231);
    let n234: ZN = zsel_n(n124, r_c277, n232);
    let n235: ZN = zsel_n(n124, r_c290, n233);
    let n236: ZB = zb_and(n125, n212);
    let n237: ZB = zb_and(n175, n213);
    let n238: ZB = zb_or(n236, n237);
    let n239: ZB = zb_or(n124, n238);
    let n241: ZW = zw_cellmix_n(20u64, r_c20, 1542469173u64);
    let n242: ZW = zw_cellmix_n(20u64, r_c20, 668265263u64);
    let n243: ZW = zw_add(zw_splat(0u64), n241);
    let n244: ZW = zw_add(zw_splat(0u64), n242);
    let n245: ZW = zw_cellmix_n(39u64, n144, 1542469173u64);
    let n246: ZW = zw_cellmix_n(39u64, n144, 668265263u64);
    let n247: ZW = zw_add(n243, n245);
    let n248: ZW = zw_add(n244, n246);
    let n249: ZW = zw_cellmix_n(84u64, n117, 1542469173u64);
    let n250: ZW = zw_cellmix_n(84u64, n117, 668265263u64);
    let n251: ZW = zw_add(n247, n249);
    let n252: ZW = zw_add(n248, n250);
    let n253: ZW = zw_cellmix_n(85u64, n174, 1542469173u64);
    let n254: ZW = zw_cellmix_n(85u64, n174, 668265263u64);
    let n255: ZW = zw_add(n251, n253);
    let n256: ZW = zw_add(n252, n254);
    let n257: ZW = zw_cellmix_n(86u64, n173, 1542469173u64);
    let n258: ZW = zw_cellmix_n(86u64, n173, 668265263u64);
    let n259: ZW = zw_add(n255, n257);
    let n260: ZW = zw_add(n256, n258);
    let n261: ZW = zw_cellmix_n(87u64, r_c87, 1542469173u64);
    let n262: ZW = zw_cellmix_n(87u64, r_c87, 668265263u64);
    let n263: ZW = zw_add(n259, n261);
    let n264: ZW = zw_add(n260, n262);
    let n265: ZW = zw_cellmix_n(20u64, n209, 1542469173u64);
    let n266: ZW = zw_cellmix_n(20u64, n209, 668265263u64);
    let n267: ZW = zw_add(zw_splat(0u64), n265);
    let n268: ZW = zw_add(zw_splat(0u64), n266);
    let n269: ZW = zw_cellmix_n(39u64, n215, 1542469173u64);
    let n270: ZW = zw_cellmix_n(39u64, n215, 668265263u64);
    let n271: ZW = zw_add(n267, n269);
    let n272: ZW = zw_add(n268, n270);
    let n273: ZW = zw_cellmix_b(41u64, r_c41, 1542469173u64);
    let n274: ZW = zw_cellmix_b(41u64, r_c41, 668265263u64);
    let n275: ZW = zw_add(n271, n273);
    let n276: ZW = zw_add(n272, n274);
    let n277: ZW = zw_add(n275, n249);
    let n278: ZW = zw_add(n276, n250);
    let n279: ZW = zw_add(n277, n253);
    let n280: ZW = zw_add(n278, n254);
    let n281: ZW = zw_add(n279, n257);
    let n282: ZW = zw_add(n280, n258);
    let n283: ZW = zw_add(n281, n261);
    let n284: ZW = zw_add(n282, n262);
    let n285: ZW = zw_cellmix_i(245u64, n210, 1542469173u64);
    let n286: ZW = zw_cellmix_i(245u64, n210, 668265263u64);
    let n287: ZW = zw_add(n283, n285);
    let n288: ZW = zw_add(n284, n286);
    let n289: ZW = zw_cellmix_i(253u64, n211, 1542469173u64);
    let n290: ZW = zw_cellmix_i(253u64, n211, 668265263u64);
    let n291: ZW = zw_add(n287, n289);
    let n292: ZW = zw_add(n288, n290);
    let n293: ZW = zw_cellmix_n(257u64, n224, 1542469173u64);
    let n294: ZW = zw_cellmix_n(257u64, n224, 668265263u64);
    let n295: ZW = zw_add(n291, n293);
    let n296: ZW = zw_add(n292, n294);
    let n297: ZW = zw_cellmix_n(270u64, n225, 1542469173u64);
    let n298: ZW = zw_cellmix_n(270u64, n225, 668265263u64);
    let n299: ZW = zw_add(n295, n297);
    let n300: ZW = zw_add(n296, n298);
    let n301: ZW = zw_cellmix_n(277u64, n234, 1542469173u64);
    let n302: ZW = zw_cellmix_n(277u64, n234, 668265263u64);
    let n303: ZW = zw_add(n299, n301);
    let n304: ZW = zw_add(n300, n302);
    let n305: ZW = zw_cellmix_n(290u64, n235, 1542469173u64);
    let n306: ZW = zw_cellmix_n(290u64, n235, 668265263u64);
    let n307: ZW = zw_add(n303, n305);
    let n308: ZW = zw_add(n304, n306);
    ...
    let live_v0_b0: u16 = ALL & zb_holds(n145) & zb_holds(n125) & zb_holds(n143);
    ...
    let live_v0_b1: u16 = ALL & zb_holds(n239);
    let sh0 = KShared0 {
        c87: r_c87,
        c39: n144,
        c84: n117,
