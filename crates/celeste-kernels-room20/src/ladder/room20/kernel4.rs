...
pub const KPART1_0: u64 = 5922312683678211919;
pub const KPART2_0: u64 = 1099119964388075113;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 2180868251631278096;
pub const KPART2_1: u64 = 15589330933981481702;
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_2: u64 = 10388043936962107023;
pub const KPART2_2: u64 = 15934586863823318640;
