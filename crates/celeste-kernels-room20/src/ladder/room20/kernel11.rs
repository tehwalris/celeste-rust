...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 16641505693332905355;
pub const KPART2_1: u64 = 13303546381587885043;
...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n207: ZN = zn_sub(r_c20, zn_splat(P8::from_raw(65536i32)));
    let n208: ZN = zsel_n(n129, n207, r_c20);
    let n209: ZI = zsel_i(n129, r_c245, n202);
    let n210: ZI = zsel_i(n129, r_c253, zi_splat(n206.0, n206.1));
    let n211: ZB = zn_le(r_c39, zn_splat(P8::from_raw(0i32)));
    let n212: ZB = zn_gt(n166, zn_splat(P8::from_raw(0i32)));
    let n213: ZN = zsel_n(n165, n166, r_c39);
    let n214: ZN = zsel_n(n129, r_c39, n213);
    let n215: ZB = zb_and(n130, n211);
    let n216: ZB = zb_and(n191, n212);
    let n217: ZB = zb_or(n215, n216);
    let n218: ZB = zn_gt(r_c276, zn_splat(P8::from_raw(0i32)));
    let n219: ZN = zn_sub(r_c276, zn_splat(P8::from_raw(65536i32)));
    let n220: ZB = zn_le(n219, zn_splat(P8::from_raw(0i32)));
    let n221: ZN = zsel_n(n218, n219, r_c276);
    let n222: ZB = zn_eq(zn_splat(P8::from_raw(1179648i32)), r_c289);
    let n223: ZN = zsel_n(n220, zn_splat(P8::from_raw(1179648i32)), r_c289);
    let n224: ZN = zsel_n(n218, n223, r_c289);
    let n225: ZN = zsel_n(n222, r_c276, n221);
    let n226: ZN = zsel_n(n222, r_c289, n224);
    let n227: ZN = zsel_n(n129, r_c276, n225);
    let n228: ZN = zsel_n(n129, r_c289, n226);
    let n229: ZB = zb_or(n129, n217);
    ...
    let n235: ZW = zw_cellmix_n(39u64, n166, 1542469173u64);
    let n236: ZW = zw_cellmix_n(39u64, n166, 668265263u64);
    let n237: ZW = zw_add(n233, n235);
    let n238: ZW = zw_add(n234, n236);
    let n239: ZW = zw_cellmix_n(84u64, n111, 1542469173u64);
    let n240: ZW = zw_cellmix_n(84u64, n111, 668265263u64);
    let n241: ZW = zw_add(n237, n239);
    let n242: ZW = zw_add(n238, n240);
    let n243: ZW = zw_cellmix_n(85u64, n177, 1542469173u64);
    let n244: ZW = zw_cellmix_n(85u64, n177, 668265263u64);
    let n245: ZW = zw_add(n241, n243);
    let n246: ZW = zw_add(n242, n244);
    let n247: ZW = zw_cellmix_n(86u64, n176, 1542469173u64);
    let n248: ZW = zw_cellmix_n(86u64, n176, 668265263u64);
    ...
    let n255: ZW = zw_cellmix_n(20u64, n208, 1542469173u64);
    let n256: ZW = zw_cellmix_n(20u64, n208, 668265263u64);
    let n257: ZW = zw_add(zw_splat(0u64), n255);
    let n258: ZW = zw_add(zw_splat(0u64), n256);
    let n259: ZW = zw_cellmix_n(39u64, n214, 1542469173u64);
    let n260: ZW = zw_cellmix_n(39u64, n214, 668265263u64);
    ...
    let n275: ZW = zw_cellmix_i(245u64, n209, 1542469173u64);
    let n276: ZW = zw_cellmix_i(245u64, n209, 668265263u64);
    let n277: ZW = zw_add(n273, n275);
    let n278: ZW = zw_add(n274, n276);
    let n279: ZW = zw_cellmix_i(253u64, n210, 1542469173u64);
    let n280: ZW = zw_cellmix_i(253u64, n210, 668265263u64);
    let n281: ZW = zw_add(n277, n279);
    let n282: ZW = zw_add(n278, n280);
    let n283: ZW = zw_cellmix_n(276u64, n227, 1542469173u64);
    let n284: ZW = zw_cellmix_n(276u64, n227, 668265263u64);
    let n285: ZW = zw_add(n281, n283);
    let n286: ZW = zw_add(n282, n284);
    let n287: ZW = zw_cellmix_n(289u64, n228, 1542469173u64);
    let n288: ZW = zw_cellmix_n(289u64, n228, 668265263u64);
