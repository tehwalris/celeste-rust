// GENERATED from a TRACED frame (shape 12). Do not edit.
//
...
pub const SHAPE: u64 = 2987095136166216928;
...
pub fn bind(b: &Rt2) -> Option<(Uni, RowSlots)> {
    ...
    let u = Uni {
        c327: match &b.cols[cell("objects[0].hitbox.h")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c328: match &b.cols[cell("objects[0].hitbox.w")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c329: match &b.cols[cell("objects[0].hitbox.x")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c330: match &b.cols[cell("objects[0].hitbox.y")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c337: match &b.cols[cell("objects[1].hitbox.h")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c338: match &b.cols[cell("objects[1].hitbox.w")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c339: match &b.cols[cell("objects[1].hitbox.x")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c340: match &b.cols[cell("objects[1].hitbox.y")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c347: match &b.cols[cell("objects[2].hitbox.h")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c348: match &b.cols[cell("objects[2].hitbox.w")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c349: match &b.cols[cell("objects[2].hitbox.x")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
        c350: match &b.cols[cell("objects[2].hitbox.y")? as usize] { Col::U(AV::Num(n)) => *n, _ => return None },
    };
    let s = RowSlots {
        c87: cell("deaths")?,
        ...
        c325: cell("objects[0].flip.x")?,
        c326: cell("objects[0].flip.y")?,
        c245: cell("objects[0].off")?,
        c331: cell("objects[0].rem.x")?,
        c332: cell("objects[0].rem.y")?,
        c247: cell("objects[0].solids")?,
        c333: cell("objects[0].spd.x")?,
        c334: cell("objects[0].spd.y")?,
        ...
        c335: cell("objects[1].flip.x")?,
        c336: cell("objects[1].flip.y")?,
        c258: cell("objects[1].hide_for")?,
        c259: cell("objects[1].hide_in")?,
        c341: cell("objects[1].rem.x")?,
        c342: cell("objects[1].rem.y")?,
        c267: cell("objects[1].solids")?,
        c343: cell("objects[1].spd.x")?,
        c344: cell("objects[1].spd.y")?,
        c269: cell("objects[1].spr")?,
        c271: cell("objects[1].x")?,
        c272: cell("objects[1].y")?,
        c275: cell("objects[2].collideable")?,
        c345: cell("objects[2].flip.x")?,
        c346: cell("objects[2].flip.y")?,
        c277: cell("objects[2].hide_for")?,
        c278: cell("objects[2].hide_in")?,
        c351: cell("objects[2].rem.x")?,
        c352: cell("objects[2].rem.y")?,
        c286: cell("objects[2].solids")?,
        c353: cell("objects[2].spd.x")?,
        c354: cell("objects[2].spd.y")?,
        c288: cell("objects[2].spr")?,
        c290: cell("objects[2].x")?,
        c291: cell("objects[2].y")?,
...
pub fn rows(b: &Rt2, s: &RowSlots, lo: usize) -> Option<RowsIn> {
    ...
    Some(RowsIn {
        ...
        c325: match &b.cols[s.c325 as usize] {
            Col::V(v) => {
                let mut m = 0u16;
                for i in 0..W {
                    match v[at(i)] {
...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 15474605421491892024;
pub const KPART2_1: u64 = 8074050154059655012;
...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let r_c286: ZB = ZB { val: rin.c286, known: ALL };
    let r_c288: ZN = rin.c288;
    let r_c290: ZN = rin.c290;
    let r_c291: ZN = rin.c291;
    let r_c325: ZB = ZB { val: rin.c325, known: ALL };
    let r_c326: ZB = ZB { val: rin.c326, known: ALL };
    let r_c331: ZN = rin.c331;
    let r_c332: ZN = rin.c332;
    let r_c333: ZN = rin.c333;
    let r_c334: ZN = rin.c334;
    let r_c335: ZB = ZB { val: rin.c335, known: ALL };
    ...
    let r_c345: ZB = ZB { val: rin.c345, known: ALL };
    ...
    let n82: ZB = zb_not(r_c42);
    let n83: ZB = zn_eq(zn_splat(P8::from_raw(65536i32)), r_c88);
    let n84: ZB = zb_not(r_c325);
    let n85: ZB = zb_not(r_c326);
    let n86: bool = P8::from_raw(524288i32) == u.c327;
    let n87: bool = P8::from_raw(524288i32) == u.c328;
    let n88: bool = P8::from_raw(0i32) == u.c329;
    let n89: bool = P8::from_raw(0i32) == u.c330;
    let n90: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c331);
    let n91: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c332);
    let n92: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c333);
    let n93: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c334);
    let n94: ZB = zn_eq(zn_splat(P8::from_raw(1703936i32)), r_c249);
    let n95: ZB = zn_eq(zn_splat(P8::from_raw(3145728i32)), r_c250);
    let n96: ZB = zn_eq(zn_splat(P8::from_raw(524288i32)), r_c252);
    let n97: ZB = zb_not(r_c336);
    let n98: bool = P8::from_raw(524288i32) == u.c337;
    let n99: bool = P8::from_raw(0i32) == u.c339;
    let n100: bool = P8::from_raw(0i32) == u.c340;
    let n101: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c341);
    let n102: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c351);
    let n103: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c352);
    let n104: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c353);
    let n107: ZN = zn_add(zn_splat(P8::from_raw(65536i32)), r_c84);
    let n108: ZN = zn_rem(n107, zn_splat(P8::from_raw(1966080i32)));
    let n109: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), n108);
    let n110: ZB = zb_not(r_c335);
    let n111: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c258);
    let n112: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c259);
    let n113: bool = P8::from_raw(524288i32) == u.c338;
    let n114: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c342);
    let n115: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c343);
    let n116: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c344);
    let n117: ZB = zn_eq(zn_splat(P8::from_raw(1179648i32)), r_c269);
    let n118: ZB = zn_eq(zn_splat(P8::from_raw(2621440i32)), r_c271);
    let n119: ZB = zn_eq(zn_splat(P8::from_raw(7340032i32)), r_c272);
    let n120: ZB = zb_not(r_c345);
    let n121: ZB = zb_not(r_c346);
    let n122: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c277);
    let n123: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c278);
    let n124: bool = P8::from_raw(524288i32) == u.c347;
    let n125: bool = P8::from_raw(524288i32) == u.c348;
    let n126: bool = P8::from_raw(0i32) == u.c349;
    let n127: bool = P8::from_raw(0i32) == u.c350;
    let n128: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), r_c354);
    let n129: ZB = zn_eq(zn_splat(P8::from_raw(1179648i32)), r_c288);
    let n130: ZB = zn_eq(zn_splat(P8::from_raw(6815744i32)), r_c290);
    let n131: ZB = zn_eq(zn_splat(P8::from_raw(7340032i32)), r_c291);
    let n132: ZB = zb_not(r_c43);
    let n133: ZN = zn_add(zn_splat(P8::from_raw(65536i32)), r_c85);
    let n134: ZN = zn_rem(n133, zn_splat(P8::from_raw(3932160i32)));
    let n135: ZB = zn_eq(zn_splat(P8::from_raw(0i32)), n134);
    let n136: ZN = zn_add(zn_splat(P8::from_raw(65536i32)), r_c86);
    let n137: ZN = zsel_n(n135, n136, r_c86);
    let n138: ZN = zsel_n(n109, n137, r_c86);
    let n139: ZN = zsel_n(n109, n134, r_c85);
    let n140: ZB = zn_gt(r_c20, zn_splat(P8::from_raw(0i32)));
    let n141: ZB = zn_le(r_c20, zn_splat(P8::from_raw(0i32)));
    let n194: ZB = zn_gt(r_c39, zn_splat(P8::from_raw(0i32)));
    let n195: ZB = zb_and(n141, n194);
    let n196: ZN = zn_sub(r_c39, zn_splat(P8::from_raw(65536i32)));
    ...
    let n209: ZN = zsel_n(n140, n208, r_c20);
    let n210: ZI = zsel_i(n140, r_c245, n203);
    let n211: ZI = zsel_i(n140, r_c253, zi_splat(n207.0, n207.1));
    let n212: ZB = zn_le(r_c39, zn_splat(P8::from_raw(0i32)));
    let n213: ZB = zb_and(n141, n212);
    let n214: ZB = zn_gt(n196, zn_splat(P8::from_raw(0i32)));
    let n215: ZB = zb_and(n195, n214);
    let n216: ZN = zsel_n(n194, n196, r_c39);
    let n217: ZB = zb_or(n213, n215);
    let n218: ZN = zsel_n(n140, r_c39, n216);
    let n219: ZB = zb_or(n140, n217);
    let n221: ZW = zw_cellmix_n(20u64, r_c20, 1542469173u64);
    let n222: ZW = zw_cellmix_n(20u64, r_c20, 668265263u64);
    let n223: ZW = zw_add(zw_splat(0u64), n221);
    let n224: ZW = zw_add(zw_splat(0u64), n222);
    let n225: ZW = zw_cellmix_n(39u64, n196, 1542469173u64);
    let n226: ZW = zw_cellmix_n(39u64, n196, 668265263u64);
    let n227: ZW = zw_add(n223, n225);
    let n228: ZW = zw_add(n224, n226);
    let n229: ZW = zw_cellmix_n(84u64, n108, 1542469173u64);
    let n230: ZW = zw_cellmix_n(84u64, n108, 668265263u64);
    let n231: ZW = zw_add(n227, n229);
    let n232: ZW = zw_add(n228, n230);
    let n233: ZW = zw_cellmix_n(85u64, n139, 1542469173u64);
    let n234: ZW = zw_cellmix_n(85u64, n139, 668265263u64);
    let n235: ZW = zw_add(n231, n233);
    let n236: ZW = zw_add(n232, n234);
    let n237: ZW = zw_cellmix_n(86u64, n138, 1542469173u64);
    let n238: ZW = zw_cellmix_n(86u64, n138, 668265263u64);
    let n239: ZW = zw_add(n235, n237);
    let n240: ZW = zw_add(n236, n238);
    let n241: ZW = zw_cellmix_n(87u64, r_c87, 1542469173u64);
    let n242: ZW = zw_cellmix_n(87u64, r_c87, 668265263u64);
    let n243: ZW = zw_add(n239, n241);
    let n244: ZW = zw_add(n240, n242);
    let n245: ZW = zw_cellmix_n(20u64, n209, 1542469173u64);
    let n246: ZW = zw_cellmix_n(20u64, n209, 668265263u64);
    let n247: ZW = zw_add(zw_splat(0u64), n245);
    let n248: ZW = zw_add(zw_splat(0u64), n246);
    let n249: ZW = zw_cellmix_n(39u64, n218, 1542469173u64);
    let n250: ZW = zw_cellmix_n(39u64, n218, 668265263u64);
    let n251: ZW = zw_add(n247, n249);
    let n252: ZW = zw_add(n248, n250);
    let n253: ZW = zw_cellmix_b(41u64, r_c41, 1542469173u64);
    let n254: ZW = zw_cellmix_b(41u64, r_c41, 668265263u64);
    let n255: ZW = zw_add(n251, n253);
    let n256: ZW = zw_add(n252, n254);
    let n257: ZW = zw_add(n255, n229);
    let n258: ZW = zw_add(n256, n230);
    let n259: ZW = zw_add(n257, n233);
    let n260: ZW = zw_add(n258, n234);
    let n261: ZW = zw_add(n259, n237);
    let n262: ZW = zw_add(n260, n238);
    let n263: ZW = zw_add(n261, n241);
    let n264: ZW = zw_add(n262, n242);
    let n265: ZW = zw_cellmix_i(245u64, n210, 1542469173u64);
    let n266: ZW = zw_cellmix_i(245u64, n210, 668265263u64);
    let n267: ZW = zw_add(n263, n265);
    let n268: ZW = zw_add(n264, n266);
    let n269: ZW = zw_cellmix_i(253u64, n211, 1542469173u64);
    let n270: ZW = zw_cellmix_i(253u64, n211, 668265263u64);
    let n271: ZW = zw_add(n267, n269);
    let n272: ZW = zw_add(n268, n270);
    let ok_v0_b0: u16 = ALL & zb_holds(r_c38) & zb_holds(n132) & zb_holds(n131) & zb_holds(n130) & zb_holds(n129) & zb_holds(n128) & zb_holds(n104) & zb_holds(r_c286) & zb_holds(n103) & zb_holds(n102) & zb_holds(n123) & zb_holds(n122) & zb_holds(n121) & zb_holds(n120) & zb_holds(r_c275) & zb_holds(n119) & zb_holds(n118) & zb_holds(n117) & zb_holds(n116) & zb_holds(n115) & zb_holds(r_c267) & zb_holds(n114) & zb_holds(n101) & zb_holds(n112) & zb_holds(n111) & zb_holds(n97) & zb_holds(n110) & zb_holds(r_c256) & zb_holds(n96) & zb_holds(n95) & zb_holds(n94) & zb_holds(n93) & zb_holds(n92) & zb_holds(r_c247) & zb_holds(n91) & zb_holds(n90) & zb_holds(n85) & zb_holds(n84) & zb_holds(r_c237) & zb_holds(n82) & zb_holds(n83);
    let bd_v0_b0: bool = !n127 || !n126 || !n125 || !n124 || !n100 || !n99 || !n113 || !n98 || !n89 || !n88 || !n87 || !n86;
    let live_v0_b0: u16 = ALL & zb_holds(n141) & zb_holds(n194) & zb_holds(n197);
    let ok_v0_b1: u16 = ALL & zb_holds(r_c38) & zb_holds(n132) & zb_holds(n131) & zb_holds(n130) & zb_holds(n129) & zb_holds(n128) & zb_holds(n104) & zb_holds(r_c286) & zb_holds(n103) & zb_holds(n102) & zb_holds(n123) & zb_holds(n122) & zb_holds(n121) & zb_holds(n120) & zb_holds(r_c275) & zb_holds(n119) & zb_holds(n118) & zb_holds(n117) & zb_holds(n116) & zb_holds(n115) & zb_holds(r_c267) & zb_holds(n114) & zb_holds(n101) & zb_holds(n112) & zb_holds(n111) & zb_holds(n97) & zb_holds(n110) & zb_holds(r_c256) & zb_holds(n96) & zb_holds(n95) & zb_holds(n94) & zb_holds(n93) & zb_holds(n92) & zb_holds(r_c247) & zb_holds(n91) & zb_holds(n90) & zb_holds(n85) & zb_holds(n84) & zb_holds(r_c237) & zb_holds(n82) & zb_holds(n83);
    let bd_v0_b1: bool = !n127 || !n126 || !n125 || !n124 || !n100 || !n99 || !n113 || !n98 || !n89 || !n88 || !n87 || !n86;
    let live_v0_b1: u16 = ALL & zb_holds(n219);
    let sh0 = KShared0 {
        c87: r_c87,
        c39: n196,
        c84: n108,
