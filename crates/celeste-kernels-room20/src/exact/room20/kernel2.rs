...
/// `append` closes the key with `mix64(KPART + kv.h)`, which is
/// byte-identical to `Rt2::boundary`'s own row key.
pub const KPART1_1: u64 = 16249946905950640694;
pub const KPART2_1: u64 = 15068294728246320069;
...
pub fn frame(u: &Uni, rin: &RowsIn, g: &G, sink: &mut dyn Sink) -> u16 {
    ...
    let n191: ZW = zw_cellmix_n(85u64, n114, 1542469173u64);
    let n192: ZW = zw_cellmix_n(85u64, n114, 668265263u64);
    let n193: ZW = zw_add(n189, n191);
    let n194: ZW = zw_add(n190, n192);
    let n195: ZW = zw_cellmix_n(86u64, n113, 1542469173u64);
    let n196: ZW = zw_cellmix_n(86u64, n113, 668265263u64);
    ...
    let n223: ZW = zw_cellmix_n(259u64, n175, 1542469173u64);
    let n224: ZW = zw_cellmix_n(259u64, n175, 668265263u64);
    let n225: ZW = zw_add(n221, n223);
    let n226: ZW = zw_add(n222, n224);
    let n227: ZW = zw_cellmix_n(272u64, n176, 1542469173u64);
    let n228: ZW = zw_cellmix_n(272u64, n176, 668265263u64);
